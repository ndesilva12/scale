...
export const mockMetrics: Metric[] = [
  { id: 'metric-1', name: 'Leadership', description: 'Ability to guide and inspire others', order: 0 },
  { id: 'metric-2', name: 'Creativity', description: 'Innovative thinking and problem solving', order: 1 },
  { id: 'metric-3', name: 'Communication', description: 'Clear and effective communication skills', order: 2 },
  { id: 'metric-4', name: 'Reliability', description: 'Dependable and consistent performance', order: 3 },
  { id: 'metric-5', name: 'Technical Skill', description: 'Domain expertise and technical abilities', order: 4 },
];
